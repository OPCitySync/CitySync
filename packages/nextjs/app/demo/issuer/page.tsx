...
const ISSUER_LEARN_CARDS: Record<IssuerLearnCardKey, LearnInfoCard> = {
  "becoming-certified-issuer": {
    ...
    relatedLinks: [{ label: "Issuer Organizations", href: docsHref("general-issuer-organizations") }],
  },
  "activity-stats": {
  ...
  "dashboard-task-operations": {
    ...
    relatedLinks: [{ label: "Task Issuance", href: docsHref("general-issuer-task-issuance") }],
  },
  "dashboard-participant-risk": {
  ...
  "epoch-issuance": {
    ...
    relatedLinks: [
      ...
      { label: "The Issuance Cap", href: docsHref("foundation-issuance-cap") },
      { label: "A Formal Economic Model", href: docsHref("foundation-formal-economic-model") },
    ],
  },
  "active-tasks": {
    title: "Active Tasks",
  ...
  "task-catalog": {
    ...
    relatedLinks: [{ label: "Task Catalog", href: docsHref("general-issuer-task-catalog") }],
  },
  "verify-flow": {
    ...
    relatedLinks: [{ label: "Task Verification", href: docsHref("general-issuer-task-verification") }],
  },
  "mycity-feed": {
...
function TutorialActionButton({
  ...
  return (
    <button
      onClick={onClick}
      style={{
        border: variant === "primary" ? "1px solid rgba(221,158,51,0.92)" : "1px solid rgba(65,105,225,0.24)",
        borderRadius: 10,
        padding: "8px 12px",
        fontSize: 12,
        fontWeight: 700,
        cursor: "pointer",
        background: variant === "primary" ? ACCENT : "rgba(65,105,225,0.1)",
        color: variant === "primary" ? BG : "#284695",
      }}
    >
      {label}
    </button>
