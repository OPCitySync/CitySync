      ...
      <section className="mx-auto max-w-7xl px-6 pb-14">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            ...
            >
              Live Mobile Application DEMO
            </p>
            <h2 className="mb-4 text-2xl font-bold text-white">Civic Wallet OS</h2>
            ...
            <div className="mt-6">
              <Link
                ...
                onClick={() => {
                  try {
                    window.localStorage.setItem(ISSUER_TUTORIAL_STORAGE_KEY, "intro");
                  } catch {
                    // Ignore storage write failures.
                  }
                }}
                className="inline-flex items-center justify-center rounded-2xl px-5 py-2.5 text-sm font-bold transition-opacity hover:opacity-90"
                style={{
                  background: "#DD9E33",
                  color: "#0D0D14",
                  textDecoration: "none",
          ...
          >
            <div
              ...
              style={{
                background: "rgba(221,158,51,0.18)",
                color: "#f2c067",
                border: "1px solid rgba(221,158,51,0.3)",
              }}
            >
              Phase 1: Local Coordination Infrastructure
            </div>
            ...
            >
              <Image
                ...
                alt="City/Sync phase 1 local coordination visual"
                fill
